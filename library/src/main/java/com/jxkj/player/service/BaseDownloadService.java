...
public abstract class BaseDownloadService extends Service {
    ...
    private static final HashMap<Class<? extends BaseDownloadService>, DownloadManagerHelper>
            downloadManagerHelpers = new HashMap<>();

    @Nullable ForegroundNotificationUpdater foregroundNotificationUpdater;
     ...
     */
    protected BaseDownloadService(int foregroundNotificationId) {
    ...
    /** @deprecated Use {@link #BaseDownloadService(int, long, String, int, int)}. */
    @Deprecated
    protected BaseDownloadService(
    ...
    public static Intent buildAddDownloadIntent(
            Context context,
            Class<? extends BaseDownloadService> clazz,
    ...
    public static Intent buildRemoveDownloadIntent(
            Context context, Class<? extends BaseDownloadService> clazz, String id, boolean foreground) {
    ...
    public static Intent buildRemoveAllDownloadsIntent(
            Context context, Class<? extends BaseDownloadService> clazz, boolean foreground) {
     ...
     */
    public static void start(Context context, Class<? extends BaseDownloadService> clazz) {
     ...
     */
    public static void startForeground(Context context, Class<? extends BaseDownloadService> clazz) {
    ...
    public void onCreate() {
        ...
        Class<? extends BaseDownloadService> clazz = getClass();
    ...
    private static Intent getIntent(
            Context context, Class<? extends BaseDownloadService> clazz, String action, boolean foreground) {
        return getIntent(context, clazz, action).putExtra(KEY_FOREGROUND, foreground);
    }

    private static Intent getIntent(
            Context context, Class<? extends BaseDownloadService> clazz, String action) {
    ...
    private final class ForegroundNotificationUpdater {
        ...
        private boolean notificationDisplayed=true;
...
//                        .notify(notificationId, notification);
    ...
    private static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        private final Class<? extends BaseDownloadService> serviceClass;

        @Nullable private BaseDownloadService downloadService;
        ...
        private DownloadManagerHelper(
                ...
                Class<? extends BaseDownloadService> serviceClass) {
        ...
        public void attachService(BaseDownloadService downloadService) {
        ...
        public void detachService(BaseDownloadService downloadService) {
        ...
        private void restartService() {
            if (foregroundAllowed) {
                try {
                    Intent intent = getIntent(context, serviceClass, ACTION_RESTART);
                    Util.startForegroundService(context, intent);
                ...
                try {
                    Intent intent = getIntent(context, serviceClass, ACTION_INIT);
                    context.startService(intent);
                } catch (IllegalStateException e) {
